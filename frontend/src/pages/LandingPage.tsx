  ...
  return (
    <div className="min-h-screen bg-[#FDFBF9] font-sans text-stone-800">
      ...
      <main className="relative max-w-7xl mx-auto px-8 pt-16 pb-24 flex h-[620px] items-center">
        <div className="pointer-events-none absolute left-[-7%] top-16 h-72 w-72 rounded-full bg-[#C49B89]/20 blur-3xl" />
        <div className="pointer-events-none absolute right-[10%] top-28 h-56 w-56 rounded-full bg-[#6B554D]/15 blur-3xl" />
        ...
        <div className="absolute top-0 right-0 w-[55%] h-full -z-10 rounded-[40px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
          <img
            ...
            className="w-full h-full object-cover object-center scale-105 opacity-80 blur-[2px]"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#FDFBF9]/30 via-[#FDFBF9]/10 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/12 via-transparent to-white/20 mix-blend-multiply" />
          <div className="absolute -left-12 top-10 h-40 w-40 rounded-full bg-white/20 blur-3xl" />
          <div className="absolute -right-10 bottom-16 h-48 w-48 rounded-full bg-[#C49B89]/25 blur-3xl" />
        </div>
      ...
      <section id="results-section" className="max-w-7xl mx-auto px-8 pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-8 items-start">
          ...
          <div className="rounded-4xl w-full h-155 shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-stone-100 overflow-hidden bg-stone-100 relative z-10">
            ...
            locationPermission === "granted" ? (
              ...
              <div className="relative flex h-full min-h-[620px] items-center justify-center overflow-hidden bg-[#F8F2EE] px-8 text-center">
                ...
                <div className="relative z-10 max-w-md rounded-[32px] border border-white/70 bg-white/75 p-8 shadow-[0_20px_60px_rgba(0,0,0,0.08)] backdrop-blur-xl">
                  ...
                  >
                    ...
                    {isLoadingLocation ? "Checking permission..." : "Allow location access"}
                  </button>
